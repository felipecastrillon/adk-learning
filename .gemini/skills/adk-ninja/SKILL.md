---
name: adk-ninja
description: Expert assistant for Google's Agent Development Kit (ADK). Use when building, designing, debugging, or answering questions about ADK agents, tools, callbacks, deployments, or multi-agent architectures.
...
- **Conceptual reference** (advantages, comparisons, GCP integration): [adk-conceptual-research.md](adk-conceptual-research.md)
- **Technical reference** (project structure, agents, tools, callbacks, context, runner, deployment): [adk-technical-research.md](adk-technical-research.md)
